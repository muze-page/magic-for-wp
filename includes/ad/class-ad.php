...
class Magick_Ad_Content
{
    ...
    public function magick_output_ad_content($arr)
    {
    ...
    public function magick_ad_judge($judge, $sign, $arr, $i, $content)
    {
        //判断是默认 - 展示
        if ($judge == '0') {
            //判断登录类型
    ...
    public function magick_ad_sign($sign)
    {
        //默认
        if ($sign == '0') {
            return true;
    ...
    public function magick_ad_fixed_content($content, $arr, $i)
    {
    ...
    public function magick_ad_platform($platform, $arr, $i)
    {
        //全平台展示
        if ($platform == '0') {
    ...
    public function magick_handle_ad_content($content, $v)
    {
        //拿到链接的值
